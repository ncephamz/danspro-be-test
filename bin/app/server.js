...
const jobsController = require('../module/jobs/controller');
...
function AppServer() {
  ...
  this.server.get('/jobs/v1/all', jwtAuth.verifyToken, jobsController.findJobs);
  this.server.get('/jobs/v1/:id', jwtAuth.verifyToken, jobsController.getJob);
